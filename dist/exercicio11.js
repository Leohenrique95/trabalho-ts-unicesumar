...
async function executarExercicio11() {
    console.log("=== Cadastro de Pessoa (POO) ===");
    // Captura de dados usando a nova fórmula
    const nomeInput = await (0, input_1.pergunta)("Digite o nome da pessoa: ") ?? "";
    const idadeInput = await (0, input_1.pergunta)("Digite a idade da pessoa: ") ?? "0";
