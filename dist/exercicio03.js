...
async function executarExercicio03() {
    console.log("=== Exercício 3 - Média de Notas ===");
    const n1 = await (0, input_1.pergunta)("Digite a primeira nota: ") ?? "0";
    const n2 = await (0, input_1.pergunta)("Digite a segunda nota: ") ?? "0";
    const n3 = await (0, input_1.pergunta)("Digite a terceira nota: ") ?? "0";
