...
async function executarExercicio01() {
    console.log("\n--- Exercício 1: Soma de dois números ---");
    const aStr = await (0, input_1.pergunta)('Digite o primeiro número: ');
    const bStr = await (0, input_1.pergunta)('Digite o segundo número: ');
